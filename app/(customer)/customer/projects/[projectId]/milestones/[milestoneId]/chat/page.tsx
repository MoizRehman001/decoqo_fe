...
/**
 * Customer milestone chat page.
 * Route: /customer/projects/[projectId]/milestones/[milestoneId]/chat
 */
...
export default function CustomerMilestoneChatPage({ params }: PageProps) {
